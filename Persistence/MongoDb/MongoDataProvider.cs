...
using MongoProviderConfigurator = Infrastructure.Configurations.MongoConfigurations.MongoProviderConfigurator;
...
namespace Persistence.MongoDb
{
    ...
    /// </remarks>
    public class MongoDataProvider : AuditDataProvider, IMongoDataProvider
    {
        ...
        public MongoDataProvider(Action<IMongoProviderConfigurator> config)
        {
